...
class WebSocket implements stub.WebSocket {
  ...
  @override
  int state_connecting = io.WebSocket.connecting;
  @override
  int state_open = io.WebSocket.open;
  @override
  int state_closing = io.WebSocket.closing;
  @override
  int state_closed = io.WebSocket.closed;
