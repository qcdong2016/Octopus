...
class WebSocket implements stub.WebSocket {
  ...
  @override
  int state_connecting = html.WebSocket.CONNECTING;

  @override
  int state_open = html.WebSocket.OPEN;

  @override
  int state_closing = html.WebSocket.CLOSING;

  @override
  int state_closed = html.WebSocket.CLOSED;
