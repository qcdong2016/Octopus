...
class WebSocket implements StreamConsumer<dynamic /*String|List<int>*/ > {
  ...
  int get state_connecting => throw _unsupportedError;
  int get state_open => throw _unsupportedError;
  int get state_closing => throw _unsupportedError;
  int get state_closed => throw _unsupportedError;
}
